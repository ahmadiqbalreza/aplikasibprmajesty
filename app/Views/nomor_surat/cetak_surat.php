...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Cetak Template Surat</h1>
            ...
            <div class="card my-3">
                <ol class="breadcrumb my-1 mx-3">
                    <li class="breadcrumb-item active small">Cetak Template Surat</li>
                </ol>
                            ...
                            <div id="flush-cetak_pengantar" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <form action="/nomor_surat/cetak_spengantar" method="POST" class="my-3">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        <div class="col">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="perihal_surat_pengantar" name="perihal_surat_pengantar" value="<?= old('perihal_surat_pengantar'); ?>" autocomplete="off">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="nomor_surat_pengantar" name="nomor_surat_pengantar" value="<?= old('nomor_surat_pengantar'); ?>">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="di_pengantar" name="di_pengantar" value="<?= old('di_pengantar'); ?>" autocomplete="off">
                            ...
                            <div id="flush-cetak_laporan_nihil" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <form action="/nomor_surat/cetak_slaporannihil" method="POST" class="my-3">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="nomor_surat_lapnihil" name="nomor_surat_lapnihil" value="<?= old('nomor_surat_lapnihil'); ?>" autocomplete="off">
                            ...
                            <div id="flush-cetak_lapprofil" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <form action="/nomor_surat/cetak_slapprofil" method="POST" class="my-3">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        <div class="col">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="perihal_surat_lapprofil" name="perihal_surat_lapprofil" value="<?= old('perihal_surat_lapprofil'); ?>">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="nomor_surat_lapprofil" name="nomor_surat_lapprofil" value="<?= old('nomor_surat_lapprofil'); ?>">
                                    ...
                                    <div class="row mb-3 mx-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="di_lapprofil" name="di_lapprofil" value="<?= old('di_lapprofil'); ?>" autocomplete="off">
